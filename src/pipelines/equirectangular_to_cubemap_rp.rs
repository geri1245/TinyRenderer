...
impl EquirectangularToCubemapRP {
    ...
    pub fn render(
        ...
        renderable: InstancedRenderableMesh,
        ...
        render_pass.set_bind_group(0, &light_bind_group, &[light_bind_group_offset]);
